...
```js
// 按需引入
import { uuid, random, randomName, md5, regExps, timeFormat, timeFrom, line2hump, hump2line } from 'pr-fetch'

// 或全量引入
import * as prTools from 'pr-fetch'
```
...
[github](https://github.com/breathe97/pr-fetch)
